...
title = 'LP-as-Equity'
+++
Since the early days of GMX, Perp DEXs have operated on two balance sheets —the token as the fundraising vehicle, and the LP as the counterparty to traders. Tokens and LPs compete as separate claims on the same revenue. The token captures fees via buybacks and staking while fees to the LP support underwriting. Yet only one of these vehicles is capable of durable value capture. 
